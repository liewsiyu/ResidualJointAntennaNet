...
subCapacityData.to_csv(r'D:\天线选择 郭志斌\正确数据集\101022\JTRAS子信道容量(p=40行列).csv')
capacityLabelData.to_csv(r'D:\天线选择 郭志斌\正确数据集\101022\JTRAS容量标签(p=40行列).csv')
subGainData.to_csv(r'D:\天线选择 郭志斌\正确数据集\101022\JTRAS子信道增益(p=40行列).csv')
gainLabelData.to_csv(r'D:\天线选择 郭志斌\正确数据集\101022\JTRAS增益标签(p=40行列).csv')
