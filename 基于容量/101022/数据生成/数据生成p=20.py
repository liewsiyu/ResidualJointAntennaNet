...
matrixData.to_csv(r'D:\天线选择 郭志斌\正确数据集\返修101022\全信道矩阵(p=20行列).csv')
fullCapacityData.to_csv(r'D:\天线选择 郭志斌\正确数据集\返修101022\全信道容量(p=20行列).csv')
subCapacityData.to_csv(r'D:\天线选择 郭志斌\正确数据集\返修101022\子信道容量(p=20行列).csv')

fullGainData.to_csv(r'D:\天线选择 郭志斌\正确数据集\返修101022\全信道增益(p=20行列).csv')
subGainData.to_csv(r'D:\天线选择 郭志斌\正确数据集\返修101022\子信道增益(p=20行列).csv')

capacityLabelData.to_csv(r'D:\天线选择 郭志斌\正确数据集\返修101022\容量标签(p=20行列).csv')
gainLabelData.to_csv(r'D:\天线选择 郭志斌\正确数据集\返修101022\增益标签(p=20行列).csv')