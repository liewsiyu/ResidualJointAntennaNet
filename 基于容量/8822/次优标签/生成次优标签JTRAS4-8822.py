...
#数据预处理
dataset = pd.read_csv(open(r'D:\天线选择 郭志斌\正确数据集\8822\全信道矩阵(p=40行列).csv')).iloc[:, 1:]
...
subCapacityData.to_csv(r'D:\天线选择 郭志斌\正确数据集\8822\JTRAS子信道容量(p=40行列).csv')
capacityLabelData.to_csv(r'D:\天线选择 郭志斌\正确数据集\8822\JTRAS容量标签(p=40行列).csv')
subGainData.to_csv(r'D:\天线选择 郭志斌\正确数据集\8822\JTRAS子信道增益(p=40行列).csv')
gainLabelData.to_csv(r'D:\天线选择 郭志斌\正确数据集\8822\JTRAS增益标签(p=40行列).csv')
