...
num_classes = n_class  # MNIST total classes (0-9digits)
...
def main():
    ...
    with tf.Session() as sess:
        ...
        for step in range(0, training_steps - 1):
            ...
            #start = (step * batch_size) % (100000)               100000应该得是训练集的大小  可是我们实际训练集的大小为160000
        ...
        for i in range(40000):
            ...
            Sub_Gain = math.sqrt(1 / 2) * np.linalg.norm(RNN_sub, ord='fro')
